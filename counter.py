...
files = [file for file in scan("F:\\Codes\\Python\\PyTube Downloader\\PyTube Downloader 2.1.3").files if file.endswith(".py") or file.endswith(".json") and file.endswith("counter.py")] 
