...
class app(ctk.CTk):
    ...
    def create_widgets(self):
        ...
        self.added_btn = ctk.CTkButton(master=self, text="Added", height=40,
                                       command=lambda: self.place_frame(self.scroll_frame_added, "added"))
        self.downloading_btn = ctk.CTkButton(master=self, text="Downloading", height=40,
                                             command=lambda: self.place_frame(self.scroll_frame_downloading,
                                                                              "downloading"))
        self.downloaded_btn = ctk.CTkButton(master=self, text="Downloaded", height=40,
    ...
    def set_widgets_colors(self):
        ...
        self.added_btn.configure(fg_color=self.app_btn_fg_color, hover_color=self.app_btn_fg_hover_color,
                                 text_color=self.app_theme_color)
        self.downloading_btn.configure(fg_color=self.app_btn_fg_color, hover_color=self.app_btn_fg_hover_color,
                                       text_color=self.app_theme_color)
        self.downloaded_btn.configure(fg_color=self.app_btn_fg_color, hover_color=self.app_btn_fg_hover_color,
                                      text_color=self.app_theme_color)
    ...
    def theme_color_change_callback(self, new_theme_color):
        ...
        for video_object in self.scroll_frame_downloading.winfo_children():
            if type(video_object) == downloadingVideo.downloadingVideo or type(
                    video_object) == downloadingPlayList.downloadingPlayList:
                video_object.set_new_theme(self.app_theme_color)

        for video_object in self.scroll_frame_downloaded.winfo_children():
            if type(video_object) == downloadedVideo.downloadedVideo or type(
                    video_object) == downloadedPlayList.downloadedPlayList:
                video_object.set_new_theme(self.app_theme_color)
