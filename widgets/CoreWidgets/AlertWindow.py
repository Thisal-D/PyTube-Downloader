...
class AlertWindow(ctk.CTk):
    def __init__(
        ...
        super().__init__(fg_color=theme_settings["alert_window"]["fg_color"]["normal"])
        ...
        self.error_msg_label = ctk.CTkLabel(
            master=self,
            text=error_msg,
            text_color=theme_settings["alert_window"]["msg_color"]["normal"],
            font=("Arial", 13, "bold")
        )
        ...
        self.button = ctk.CTkButton(
            border_width=2,
            border_color=theme_settings["root"]["accent_color"]["normal"],
            master=self,
            hover_color=theme_settings["root"]["accent_color"]["hover"],
            command=self.close_error_window,
            text=button_text,
            fg_color=theme_settings["root"]["accent_color"]["normal"],
            width=120
        )
