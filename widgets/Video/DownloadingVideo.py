...
class DownloadingVideo(Video):
    ...
    def display_status(self):
        if self.download_state == "failed":
            self.status_label.configure(text_color=self.theme_settings["error_color"]["normal"], text="Failed")
        elif self.download_state == "waiting":
            self.status_label.configure(text_color=self.theme_settings["text_color"]["normal"], text="Waiting")
        elif self.download_state == "paused":
            self.status_label.configure(text_color=self.theme_settings["text_color"]["normal"], text="Paused")
        elif self.download_state == "downloading":
            self.status_label.configure(text_color=self.theme_settings["text_color"]["normal"], text="Downloading")
        elif self.download_state == "pausing":
            self.status_label.configure(text_color=self.theme_settings["text_color"]["normal"], text="Pausing")
        elif self.download_state == "completed":
            self.status_label.configure(text_color=self.theme_settings["text_color"]["normal"], text="Downloaded")
    ...
    def on_mouse_enter_self(self, event):
        ...
        self.re_download_btn.configure(fg_color=self.theme_settings["fg_color"]["hover"])
        self.pause_resume_btn.configure(fg_color=self.theme_settings["fg_color"]["hover"])
    ...
    def on_mouse_leave_self(self, event):
        ...
        self.re_download_btn.configure(fg_color=self.theme_settings["fg_color"]["normal"])
        self.pause_resume_btn.configure(fg_color=self.theme_settings["fg_color"]["normal"])

    def set_accent_color(self):
        super().set_accent_color()
        self.download_progress_bar.configure(
            progress_color=self.accent_color["normal"]
        )
