...
class Video(ctk.CTkFrame):
    ...
    def set_accent_color(self):
        self.configure(border_color=self.accent_color["normal"])
        self.thumbnail_btn.configure(
            fg=(self.accent_color["normal"]),
        )
        self.channel_btn.configure(activeforeground=self.accent_color["normal"])
        self.url_label.configure(fg=self.accent_color["normal"])
    ...
    def reset_widgets_colors(self):
        self.thumbnail_btn.configure(
            ...
            activebackground=ThemeManager.get_color_based_on_theme(self.theme_settings["fg_color"]["normal"])
        )
    ...
    def set_widgets_colors(self):
        self.configure(fg_color=self.theme_settings["fg_color"]["normal"])
