...
class DownloadedVideo(Video):
    ...
    def set_accent_color(self):
        ...
        self.download_path_btn.configure(text_color=ThemeManager.theme_settings["root"]["accent_color"]["normal"])
    ...
    def on_mouse_enter_self(self, event):
        ...
        self.download_path_btn.configure(fg_color=ThemeManager.theme_settings["video_object"]["fg_color"]["hover"])

    def on_mouse_leave_self(self, event):
        super().on_mouse_leave_self(event)
        self.download_path_btn.configure(fg_color=ThemeManager.theme_settings["video_object"]["fg_color"]["normal"])

    def bind_widget_events(self):
        super().bind_widget_events()

        def on_mouse_enter_download_path_btn(event):
            self.download_path_btn.configure(text_color=ThemeManager.theme_settings["root"]["accent_color"]["hover"])
