...
class DownloadingVideo(Video):
    ...
    def set_downloading_failed(self):
        ...
        if self.download_state != "removed":
            ...
            self.re_download_btn.place(
                y=ScaleSettings.settings["DownloadingVideo"][str(GeneralSettings.settings["scale_r"])][7],
                relx=1,
    ...
    def set_widgets_accent_color(self):
        ...
        self.download_progress_bar.configure(progress_color=ThemeSettings.settings["root"]["accent_color"]["normal"])
        self.re_download_btn.configure(text_color=ThemeSettings.settings["root"]["accent_color"]["normal"])
        self.pause_resume_btn.configure(text_color=ThemeSettings.settings["root"]["accent_color"]["normal"])
    ...
    def set_widgets_colors(self) -> None:
        ...
        self.net_speed_label.configure(text_color=ThemeSettings.settings["video_object"]["text_color"]["normal"])
        self.status_label.configure(text_color=ThemeSettings.settings["video_object"]["text_color"]["normal"])
    ...
    def configure_widget_sizes(self, _event):
        ...
        self.sub_frame.configure(width=self.master.winfo_width() / 2 - 100 * GeneralSettings.settings["scale_r"])
