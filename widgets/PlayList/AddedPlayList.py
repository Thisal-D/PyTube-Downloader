...
class AddedPlayList(PlayList):
    ...
    def reload_playlist(self):
        ...
        self.status_label.configure(text_color=self.accent_color["normal"], text="Loading")
        if len(self.videos) != 0:
    ...
    def clear_loading_failure(self):
        self.status_label.configure(text="Loading", text_color=self.theme_settings["text_color"]["normal"])
        self.reload_btn.place_forget()
