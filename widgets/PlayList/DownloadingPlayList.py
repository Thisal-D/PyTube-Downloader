...
import threading
from typing import List, Any, Literal, Union, Dict, Callable
...
class DownloadingPlayList(PlayList):
    ...
    def indicate_downloading_failure(self):
        ...
        self.status_label.configure(text="Failed", text_color=self.theme_settings["error_color"]["normal"])

    def clear_downloading_failure(self):
        self.re_download_btn.place_forget()
        self.status_label.configure(text="Downloading", text_color=self.theme_settings["text_color"]["normal"])

    def set_downloading_completed(self):
        self.status_label.configure(text="Downloaded", text_color=self.theme_settings["text_color"]["normal"])
    ...
    def set_accent_color(self):
        ...
        self.re_download_btn.configure(text_color=self.accent_color["normal"])
